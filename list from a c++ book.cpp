...
int main()
{
	...
	ostream_iterator<int> screen(cout, " "); //Line 2			// osIdentifier = screen or another container // here screen is just an identifier..
...
//or:
	...
	copy(intList1.begin(), intList1.end(), screen); //Line 13		// here screen is just an identifier..
	cout << endl; //Line 14
	...
	cout << endl; //Line 18
	intList1.unique(); //Line 19		If the consecutive elements in listCont have the same value, removes the duplicates.
