//write "quit" to quit or write prefix e.g. + (ab) :
//
//	+ab
//	Given Prefix Expression : +ab
//	Infix Expression : (a + b)
//	write "quit" to quit or write prefix e.g. + (ab) :
//
//	+/+XYC*+ABD
//	Given Prefix Expression : +/+XYC*+ABD
//	Infix Expression : (((X + Y) / C) + ((A + B)*D))
//	write "quit" to quit or write prefix e.g. + (ab) :
...
void prefixtoinfix(char prfx[50]);
char prfx[50];
...
void prefixtoinfix(char prfx [50]) {
	...
	char ch, str[50], opnd1[50], opnd2[50], opr[3];
